package com.hanserwei.count.exception;

import com.hanserwei.count.enums.ResponseCodeEnum;
 ...
 * 使用 {@link RestControllerAdvice}，各处理方法无需再标注 {@code @ResponseBody}。
 *
 * @author hanserwei
 * @date 2026/07/11
 * @since 0.0.1
...
public class GlobalExceptionHandler {
    ...
    /**
     * 捕获 {@code @Valid} 注解触发的参数校验异常，拼接各字段错误信息后返回。
     */
